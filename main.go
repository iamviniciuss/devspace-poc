...
func main() {
		...
		<html>
			...
			<body>
				<section>
					<div class="container">
						<div class="left">
							<h1>XXX 21 - You deployed this project with<img class="logo" src="https://static.loft.sh/branding/logos/devspace/horizontal/mono/devspace_horizontal_mono.svg" alt="DevSpace" /></h1>
	...
	fmt.Println("Started server on http://localhost:9000")
